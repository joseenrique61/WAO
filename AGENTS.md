...
- Crea la clase de la acción en el paquete `com.wao.WAO.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="com.wao.WAO.acciones.MostrarImporte"/>
</controlador>
```
...
- ✅ Coloca las clases de acción en `com.wao.WAO.acciones`
...
- Crea un paquete `cuadrosmando` (ej. `com.wao.WAO.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
